    ...
    render() {
        return (
            ...
            <div className="row masonry-wrap">
                <div className="masonry" style={{position: "relative", height: 1082}}>
    
                    <div className="masonry__brick" style={{position: "absolute", left: 0, top: 0}}>
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 333, top: 0}}>
                        <div className="item-folio">
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 666, top: 0}}>
                        <div className="item-folio">
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 0, top: 333}}>
                        <div className="item-folio">
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 666, top: 333}}>
                        <div className="item-folio">
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 333, top: 416}}>
                        <div className="item-folio">
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 0, top: 749}}>
                        <div className="item-folio">
                    ...
                    <div className="masonry__brick" style={{position: "absolute", left: 666, top: 749}}>
                        <div className="item-folio">
