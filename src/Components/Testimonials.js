            ...
            <div className="row testimonials">
                ...
                <div className="col-full testimonials__slider">
                    ...
                    <div className="testimonials__slide">
                        <img src="images/avatars/user-01.jpg" className="testimonials__avatar" />
                    ...
                    <div className="testimonials__slide">
                        <img src="images/avatars/user-05.jpg" className="testimonials__avatar" />
                    ...
                    <div className="testimonials__slide">
                        <img src="images/avatars/user-02.jpg" className="testimonials__avatar" />
